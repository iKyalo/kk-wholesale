            ...
            <div class="col-md-2">
                ...
                <select name="role" class="form-select">
                    ...
                    @foreach ($roles as $roleValue => $roleLabel)
                        <option value="{{ $roleValue }}" {{ (string) request('role') === (string) $roleValue ? 'selected' : '' }}>
                            {{ $roleLabel }}
                        </option>
                    @endforeach
                </select>
    ...
    <div class="card-body">
        ...
        @forelse ($users as $user)
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    @if ($user->is_active)
                                        Are you sure you want to deactivate <strong>{{ $user->name }}</strong>? They will no longer be able to sign in.
                                    @else
                                        Are you sure you want to activate <strong>{{ $user->name }}</strong>? They will regain access to the system.
                                    @endif
                                </div>
            ...
            @if ($loop->last)
                ...
                @if ($users instanceof \Illuminate\Contracts\Pagination\Paginator || $users instanceof \Illuminate\Pagination\LengthAwarePaginator)
                    <div class="mt-3">
