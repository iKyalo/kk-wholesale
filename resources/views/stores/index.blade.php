...
<div class="container-fluid px-3 px-md-4">
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-end gap-1">
                                        <a href="{{ route('stores.show', $store) }}" class="btn btn-sm btn-outline-secondary" title="View">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                        <a href="{{ route('stores.edit', $store) }}" class="btn btn-sm btn-outline-primary" title="Edit">
            ...
            @if ($stores instanceof \Illuminate\Contracts\Pagination\Paginator || $stores instanceof \Illuminate\Pagination\LengthAwarePaginator)
                <div class="mt-3">
                    {{ $stores->links() }}
                </div>
            @endif
