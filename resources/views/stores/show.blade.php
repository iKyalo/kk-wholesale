...
<div class="container-fluid px-3 px-md-4">
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-white border-0 pt-3 d-flex align-items-center justify-content-between">
            ...
            <a href="{{ route('stores.users.edit', $store) }}" class="btn btn-sm btn-outline-primary">Assign Users</a>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-end gap-1">
                                        <a href="{{ route('users.show', $user) }}" class="btn btn-sm btn-outline-secondary" title="View User">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                        <button
                                            type="button"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    Remove <strong>{{ $user->name }}</strong> from {{ $store->name }}?
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">Cancel</button>
                                                    <form method="POST" action="{{ route('stores.users.remove', [$store, $user]) }}">
                                                        @csrf
                                                        @method('DELETE')
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="text-center text-muted py-4">No users assigned to this store yet.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
