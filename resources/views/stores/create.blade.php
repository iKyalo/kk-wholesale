...
<div class="container-fluid px-3 px-md-4">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            <h1 class="h3 fw-bold mb-0">Create Store</h1>
            <p class="text-muted small mb-0">Add a new store under a branch.</p>
        </div>
        ...
        <div class="card-body p-4">
            <form method="POST" action="{{ route('stores.store') }}" novalidate>
                ...
                <div class="d-flex gap-2 mt-4">
                    ...
                    <a href="{{ route('stores.index') }}" class="btn btn-outline-secondary px-4">Cancel</a>
                </div>
            </form>
        </div>
    </div>
