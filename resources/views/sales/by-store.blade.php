            ...
            @isset($store)
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-end gap-1">
                                                    ...
                                                    <a href="{{ route('sales.show', $sale) }}?print=1"
                        ...
                        @if (
                            $sales instanceof \Illuminate\Contracts\Pagination\Paginator ||
                                $sales instanceof \Illuminate\Pagination\LengthAwarePaginator)
                            <div class="mt-3">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const allStores = Array.from(
                storeSelect.querySelectorAll('option[data-branch-id]')
            );
            ...
            function filterStores() {
                ...
                defaultOption.value = '';
                defaultOption.textContent = branchId ?
                    'Select a Store' :
                ...
                const matchingStores = allStores.filter(function(option) {
                    return option.dataset.branchId === branchId;
                });

                matchingStores.forEach(function(option) {
                    storeSelect.appendChild(option.cloneNode(true));
                });

                storeSelect.disabled = matchingStores.length === 0;

                if (matchingStores.some(function(option) {
