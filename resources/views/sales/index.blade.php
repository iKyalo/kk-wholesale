            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body">
                    <form method="GET" action="{{ route('sales.index') }}" class="row g-2 align-items-center">
                        <div class="col-md-2">
                            <input type="text" name="search" class="form-control" placeholder="Sale #"
                        ...
                        <div class="col-md-2">
                            <select name="payment_method" class="form-select">
                                ...
                                <option value="mpesa" {{ request('payment_method') === 'mpesa' ? 'selected' : '' }}>M-Pesa
                                </option>
                        ...
                        @if (request()->anyFilled(['search', 'branch_id', 'store_id', 'payment_method', 'status', 'date_from', 'date_to']))
                            <div class="col-md-3 d-flex align-items-end">
                                <a href="{{ route('sales.index') }}" class="btn btn-outline-secondary w-100">Clear
                                    Filters</a>
                            </div>
                        @endif
                    </form>
