...
<div class="container-fluid px-3 px-md-4">
        ...
        <div class="card-body">
            <form method="GET" action="{{ route('inventory.index') }}" class="row g-2 align-items-center">
                ...
                @if (request('search') || request('branch_id') || request('store_id') || request('status'))
                    <div class="col-12">
                        <a href="{{ route('inventory.index') }}" class="btn btn-sm btn-outline-secondary">Clear Filters</a>
                    </div>
                @endif
            </form>
        </div>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-end gap-1">
                                        <a href="{{ route('inventory.show', $inventory) }}" class="btn btn-sm btn-outline-secondary" title="View Inventory">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                        <a href="{{ route('inventory.edit-stock', ['inventory' => $inventory->id]) }}" class="btn btn-sm btn-outline-primary" title="Update Stock">
            ...
            @if ($inventories instanceof \Illuminate\Contracts\Pagination\Paginator || $inventories instanceof \Illuminate\Pagination\LengthAwarePaginator)
                <div class="mt-3">
                    {{ $inventories->links() }}
                </div>
            @endif
