                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-6">
                                    ...
                                    <p class="fw-semibold mb-0">KSh
                                        {{ number_format($inventory->product->cost_price ?? 0, 2) }}</p>
                                </div>
                                <div class="col-6">
                                    <p class="text-muted small mb-1">Selling Price</p>
                                    <p class="fw-semibold mb-0">KSh
                                        {{ number_format($inventory->product->selling_price ?? 0, 2) }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @switch($movement->type)
                                                ...
                                                @default
                                                    <span
                                                        class="badge text-bg-secondary">{{ ucfirst(str_replace('_', ' ', $movement->type)) }}</span>
                                            @endswitch
                                        </td>
                                        <td>{{ $movement->quantity > 0 ? '+' : '' }}{{ number_format($movement->quantity) }}
                                        </td>
