        ...
        <ul class="nav flex-column sidebar-nav">
            ...
            <li class="nav-item">
                <a
                    ...
                    class="nav-link {{ $isActive('branches.*') ? 'active' : '' }}"
                    data-bs-toggle="tooltip"
                    data-bs-placement="right"
                    title="Branches"
                >
            ...
            <li class="nav-item">
                <a
                    ...
                    class="nav-link {{ $isActive('stores.*') ? 'active' : '' }}"
                    data-bs-toggle="tooltip"
                    data-bs-placement="right"
                    title="Stores"
                >
            ...
            <li class="nav-item">
                <a
                    ...
                    role="button"
                    aria-expanded="{{ $isActive('inventory.*') ? 'true' : 'false' }}"
                ...
                <div class="collapse submenu {{ $isActive('inventory.*') ? 'show' : '' }}" id="inventorySubmenu">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a href="{{ route('inventory.index') }}" class="nav-link {{ $isActive('inventory.index') ? 'active' : '' }}">
                                All Inventory
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('inventory.by-store') }}" class="nav-link {{ $isActive('inventory.by-store') ? 'active' : '' }}">
                                By Store
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('inventory.edit-stock') }}" class="nav-link {{ $isActive('inventory.edit-stock') ? 'active' : '' }}">
                                Update Stock
                            </a>
                        </li>
                    </ul>
            ...
            <li class="nav-item">
                <a
                    href="#salesSubmenu"
                    class="nav-link submenu-toggle {{ $isActive('sales.*') ? 'active' : '' }}"
                    data-bs-toggle="collapse"
                    role="button"
                    aria-expanded="{{ $isActive('sales.*') ? 'true' : 'false' }}"
                ...
                <div class="collapse submenu {{ $isActive('sales.*') ? 'show' : '' }}" id="salesSubmenu">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a href="{{ route('sales.index') }}" class="nav-link {{ $isActive('sales.index') ? 'active' : '' }}">
                                All Sales
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('sales.create') }}" class="nav-link {{ $isActive('sales.create') ? 'active' : '' }}">
                                Create Sale
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('sales.by-store') }}" class="nav-link {{ $isActive('sales.by-store') ? 'active' : '' }}">
                                By Store
                            </a>
                        </li>
                    </ul>
            ...
            <li class="nav-item">
                <a
                    href="#transfersSubmenu"
                    class="nav-link submenu-toggle {{ $isActive('transfers.*') ? 'active' : '' }}"
                    data-bs-toggle="collapse"
                    role="button"
                    aria-expanded="{{ $isActive('transfers.*') ? 'true' : 'false' }}"
                    aria-controls="transfersSubmenu"
                    data-bs-placement="right"
                ...
                <div class="collapse submenu {{ $isActive('transfers.*') ? 'show' : '' }}" id="transfersSubmenu">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a href="{{ route('transfers.index') }}" class="nav-link {{ $isActive('transfers.index') ? 'active' : '' }}">
                                All Transfers
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('transfers.create') }}" class="nav-link {{ $isActive('transfers.create') ? 'active' : '' }}">
                                Create Transfer
                            </a>
                        </li>
                    </ul>
